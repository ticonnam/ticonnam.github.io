...
const Projects = () => {
  ...
  // Close zoom and navigate with keyboard
  useEffect(() => {
              ...
              {expandedIndex === i && (
                ...
                >
                  <div className="space-y-8">
                    ...
                    <div className="pt-4">
                       <p className="text-[10px] text-white/30 uppercase tracking-widest font-bold mb-4">Research Artifacts (Click to Zoom)</p>
      ...
      <AnimatePresence>
        {zoomImg && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            // FIX: Priority Z-index and pointer interaction
