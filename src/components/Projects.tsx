        ...
        {isOpen && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-6xl h-full bg-[#0d0d0d] rounded-[2rem] border border-white/10 overflow-hidden flex flex-col shadow-2xl will-change-transform"
              ...
              >
                <div className="min-h-full w-full flex flex-col items-center p-6 md:p-12 space-y-12">
                  <motion.img
                    ...
                    className={`rounded-xl shadow-2xl will-change-transform ${
                      isZoomed
                        ? "w-full"
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {projects.map((p, i) => (
          <motion.div
            ...
            className="group cursor-pointer bg-white/5 border border-white/5 rounded-[2.5rem] p-8 hover:bg-white/[0.08] will-change-transform"
          >
            <div className="aspect-[4/3] rounded-2xl overflow-hidden mb-8 bg-slate-900 relative">
              <img
                src={p.images[0]}
                loading="lazy"
                className="w-full h-full object-cover transform-gpu transition-transform duration-500 group-hover:scale-[1.01]"
              />
              ...
              <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300 bg-indigo-900/60">
                <div className="bg-white text-black px-6 py-3 rounded-full font-bold text-[10px] uppercase tracking-widest shadow-xl flex items-center gap-2">
